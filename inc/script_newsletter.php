                ...
                $header="MIME-Version: 1.0 \e\n";
                    ...
                    $message='<html><head><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
                                ...
                                <div style="text-align: center; padding: 20px">
                                    ...
                                    <h1 style="font-family: sans-serif; color: #a05d38;">Bienvenue à notre newsletter, jeune cowboy !</h1><br>
                                    <p style="font-family: sans-serif;">Chaque semaine, tu recevras toutes les actualités concernant le jeu Winchester à cette adresse mail (';
                    $message.=$email;
                    $message.=').</p>
                                </div>
                            </body></html>';

                mail($email, "Inscription à la newsletter (Winchester)", $message, $header);
